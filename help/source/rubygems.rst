...
::
    ...
    gem sources -a https://mirror.nyist.edu.cn/rubygems/  #添加NYIST源

针对使用 Gemfile 和 Bundle 的项目
-------------------------------------

参考： `Gem Source Mirrors @ Bundle Docs <http://bundler.io/v1.5/bundle_config.html#gem-source-mirror-1>`_
